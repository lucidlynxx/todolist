            ...
            <div class="col-md-10 mx-auto col-lg-5">
                <form class="p-4 p-md-5 border rounded-3 bg-light" method="post" action="/todolist">
                    ...
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control @error('todo')
                            is-invalid
                        @enderror" name="todo" placeholder="todo">
                        @error('todo')
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $l->lists }}</td>
                            <form id="deleteForm" action="/todolist/delete/{{ $l->id }}" method="post">
                                @csrf
                                <td class="d-flex justify-content-end">
                                    <button class="w-75 btn btn-lg btn-danger d-inline inline-flex"
